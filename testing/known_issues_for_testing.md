...
| Issues | Severity | Workaround |
| ------ | -------- | ---------- |
| Not all scenarios are available for all variables | Medium | Check Data Availability tab |
...
| Draw polygon may be experimental | Low | Use upload AOI or Jambongan if it fails |
| Point-buffer may be experimental | Low | Use upload AOI or Jambongan if it fails |
